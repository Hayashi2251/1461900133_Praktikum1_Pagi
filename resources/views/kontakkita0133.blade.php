      ...
      <div class="pt-24">
        <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
          ...
          <div class="flex flex-col w-full md:w-2/5 justify-center items-center text-center md:text-left">
            <img class="w-full md:w-4/5 z-50" src="{{url('/PMSiloam.png')}}" />
            <button class="mx-auto lg:mx-0 hover:underline bg-red-400 text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
              Edit
            </button>
          </div>
          <!--Right Col-->
          <div class="my-4 text-5xl font-bold leading-tight text-gray-800">
            Kontak:081332660932
            <br>
